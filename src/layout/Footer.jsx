function Footer() {
    return (
        <div className='bg-slate-950 px-4'>
            <footer className="justify-center bg-radial-[at_50%_110%] from-violet-800 via-slate-900 to-slate-950 to-70% w-full max-w-[1350px] mx-auto text-white pt-8 lg:pt-12 px-4 sm:px-8 md:px-16 lg:px-28 rounded-tl-3xl rounded-tr-3xl overflow-hidden">
